...
| [003](003-dual-mode-input.md) | Dual-mode input (extract / verify) | ⚠ Partial — Mode A application-matching implemented (R-APP-01–R-APP-05, 12 stubs, UI toggle + catalog endpoint); full COLA on-file integration deferred |
...
| [013](013-batch-processing-poc.md) | Batch processing — client-side UI PoC | ⚠ Partial — batch tab in React frontend; sequential single-check calls; no new backend endpoint |
